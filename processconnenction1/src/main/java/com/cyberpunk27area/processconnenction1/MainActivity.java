...
public class MainActivity extends AppCompatActivity {
    ...
    private void connection() {
        Intent intent = new Intent(this, SharedBooksService.class);
    ...
    private void addSharedBook() {
        ...
        for (int i = 0; i < 10; i++) {
            try {
                shareBooks.addBook(new Book("server shared title:" + i, "server shared content:" + i));
    ...
    private void addBooks() {
        try {
            ...
            for (int i = 0; i < 10; i++) {
                booksBinderImpl.addBook(new Book("service title:" + i, "service content:" + i));
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
