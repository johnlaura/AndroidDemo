...
import com.cyberpunk27area.processconnenction1.IBinderPool;
...
public class BinderPool {
    ...
    private synchronized void connectionService(Context context) {
        ...
        service.setAction("com.cyberpunk27area.processconnenction1.BinderPoolService");
        service.setPackage("com.cyberpunk27area.processconnenction1");//设置服务端的package
